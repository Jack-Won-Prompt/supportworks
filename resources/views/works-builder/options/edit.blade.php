...
<div x-data="wbOptions(@js([
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-5">
            ...
            <span class="text-xs text-gray-400" x-show="previewing">와이어프레임 렌더 중…</span>
        </div>
        ...
        <form @submit.prevent="save()" class="text-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            @else
                                ...
                                <p class="text-xs text-gray-400 mt-1">선택한 테마 자산이 출력 zip의 <code>assets/theme/</code> 에 자동 포함됩니다.</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-3">
                    ...
                    <p class="text-xs text-gray-400 mt-2">⚠ 와이어프레임은 담당자 확인용입니다. 웍스 프롬프트에는 포함되지 않습니다 (명세 v11 §1.4).</p>
                </div>
            </div>
