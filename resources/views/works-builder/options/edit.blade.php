            ...
            <div class="flex items-start justify-between gap-3 flex-wrap">
                ...
                <div class="relative flex-shrink-0">
                    <button type="button" @click.stop="openPop = !openPop"
                            ...
                            class="inline-flex items-center gap-2 px-3.5 py-2 text-sm border rounded-lg font-medium transition-colors">
                        ...
                        옵션
                        <span class="inline-flex items-center gap-1 text-[11px] font-mono text-gray-500">
                            <span class="inline-block w-3 h-3 rounded border border-gray-300" :style="`background:${form.main_color};`"></span>
                            <span x-text="form.gnb_position"></span>
                            <span class="text-gray-300">·</span>
                            <span x-text="form.tab_structure"></span>
                        </span>
                    ...
                    <div x-show="openPop" x-cloak x-transition.opacity.duration.150ms @click.stop
                         class="absolute right-0 top-full mt-2 w-[420px] bg-white rounded-xl shadow-lg border border-gray-200 z-30 overflow-hidden">
                        <div class="px-4 py-2.5 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                            <h4 class="text-xs font-semibold text-gray-700">레이아웃 옵션</h4>
                            <button type="button" @click="openPop = false" class="text-gray-400 hover:text-gray-600">
                        ...
                        <div class="p-4 grid grid-cols-2 gap-3">
                            ...
                            <div class="col-span-2">
                                ...
                                @if (empty($themes))
                                    <div class="bg-amber-50 border border-amber-200 rounded-lg px-2 py-2 text-xs text-amber-700">등록된 테마 없음.</div>
                                @else
