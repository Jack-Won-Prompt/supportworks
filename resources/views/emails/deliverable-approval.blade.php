...
<title>{{ __('deliverables.email_req_title') }}</title>
</head>
    ...
    <tr>
      <td style="background:linear-gradient(135deg,#ede9fe,#ddd6fe,#e0e7ff);padding:32px 36px 28px;text-align:center;">
        ...
        <h1 style="margin:0 0 6px;font-size:18px;font-weight:700;color:#3730a3;">
          {{ __('deliverables.email_req_title') }}
        </h1>
        <p style="margin:0;font-size:13px;color:#6d28d9;">
          {{ __('deliverables.email_req_subtitle', ['name' => $requesterName]) }}
        </p>
      </td>
    </tr>
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%;background:#f5f3ff;border-radius:10px;border:1px solid #ede9fe;">
          <tr>
            <td style="padding:14px 18px;border-bottom:1px solid #ede9fe;background:#ede9fe;">
              <span style="font-size:11px;font-weight:700;color:#7c3aed;padding:3px 9px;background:#fff;border-radius:20px;border:1px solid #7c3aed;">{{ __('deliverables.email_req_badge') }}</span>
              <span style="font-size:12px;font-weight:600;color:#5b21b6;margin-left:10px;">{{ __('deliverables.email_deliverable') }}</span>
            </td>
          </tr>
          <tr>
            <td style="padding:16px 18px;">
              ...
              <p style="margin:0;font-size:13px;color:#6d28d9;">
                {{ __('deliverables.email_step', ['title' => $stepTitle]) }}
              </p>
            </td>
          </tr>
        </table>
    ...
    <tr>
      <td style="padding:20px 36px 0;">
        <table cellpadding="0" cellspacing="0" style="width:100%;">
          <tr>
            <td style="font-size:12px;color:#6b7280;">{{ __('deliverables.email_requester') }}</td>
