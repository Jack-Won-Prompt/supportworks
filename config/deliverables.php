    ...
    'deliverables' => [
        ...
        'USR' => [
            ...
            'steps'          => [
                ...
                ['order'=>3,'title'=>'비즈니스 기능 요구사항','description'=>'기능 단위 요구 목록','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'funcReqs','label'=>'기능 요구사항','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'AI-CHAT']],'required'=>true],
                ['order'=>4,'title'=>'비즈니스 이관 요구사항','description'=>'이관 절차, 가용성','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'migrationReqs','label'=>'이관 요구사항','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA']],'required'=>false],
                ...
                ['order'=>6,'title'=>'IT 요구사항','description'=>'성능/보안/연계','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'itReqs','label'=>'IT 요구사항','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA']],'required'=>false],
        ...
        'FRS' => [
            ...
            'steps'          => [
                ...
                ['order'=>4,'title'=>'기능 명세','description'=>'화면·기능별 동작','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'funcSpec','label'=>'기능 명세','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'AI-CHAT']],'required'=>true],
                ['order'=>5,'title'=>'인터페이스 정의','description'=>'API/연계 시스템','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'interfaces','label'=>'인터페이스 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'DIAGRAM-SEQ']],'required'=>false],
        ...
        'InfoSec' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'자산·데이터 분류','description'=>'자산·민감도 입력(A)','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'assets','label'=>'자산 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'FORM-CHECKLIST']],'required'=>true],
                ...
                ['order'=>5,'title'=>'잔여 위험 및 승인','description'=>'이해관계자 검토, 승인','inputType'=>'review','fields'=>[['key'=>'residualRisk','label'=>'잔여 위험 내용','type'=>'textarea']],'tools'=>[['toolId'=>'MATRIX-RISK'],['toolId'=>'APPROVE'],['toolId'=>'EXPORT']],'required'=>true],
            ],
        ],
        ...
        'RoPA' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'처리 목적·법적 근거','description'=>'처리 목적·관련 법규','inputType'=>'form','fields'=>[['key'=>'purpose','label'=>'처리 목적 및 법적 근거','type'=>'textarea']],'tools'=>[['toolId'=>'FORM-QA'],['toolId'=>'AI-CHAT']],'required'=>true],
                ['order'=>2,'title'=>'개인정보 항목','description'=>'A+B 수집 항목','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'piiItems','label'=>'개인정보 항목','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA']],'required'=>true],
                ...
                ['order'=>4,'title'=>'보관·폐기','description'=>'보관 기간·폐기 절차','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'retention','label'=>'보관 및 폐기 정책','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA']],'required'=>false],
                ['order'=>5,'title'=>'3자 제공·국외 이전','description'=>'3자 제공·국외 이전 정보','inputType'=>'form','fields'=>[['key'=>'thirdParty','label'=>'제3자 제공 정보','type'=>'textarea']],'tools'=>[['toolId'=>'FORM-QA'],['toolId'=>'MATRIX-RISK']],'required'=>false],
                ['order'=>6,'title'=>'검토 및 등록','description'=>'이해관계자 검토, 승인','inputType'=>'review','fields'=>[['key'=>'reviewNotes','label'=>'검토 의견','type'=>'textarea']],'tools'=>[['toolId'=>'APPROVE'],['toolId'=>'EXPORT']],'required'=>true],
            ],
        ],
        ...
        'Access' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'역할 정의','description'=>'A 비즈니스 역할','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'roles','label'=>'역할 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'AI-CHAT']],'required'=>true],
                ...
                ['order'=>5,'title'=>'SSO/계정 관리','description'=>'SSO 통합·계정 관리 정책','inputType'=>'form','fields'=>[['key'=>'ssoPolicy','label'=>'SSO 및 계정 정책','type'=>'textarea']],'tools'=>[['toolId'=>'AI-CHAT'],['toolId'=>'FORM-CHECKLIST']],'required'=>false],
        ...
        'Audit' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'로그 대상 식별','description'=>'트랜잭션·데이터','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'logTargets','label'=>'로그 대상 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'FORM-CHECKLIST']],'required'=>true],
                ['order'=>2,'title'=>'로그 항목 정의','description'=>'Who/What/When/Where/Why','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'logSchema','label'=>'로그 스키마','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA']],'required'=>true],
        ...
        'PhySec' => [
            ...
            'steps'          => [
                ...
                ['order'=>4,'title'=>'백업 첨부·요약','description'=>'보안 백업 업로드','inputType'=>'upload','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'backupDoc','label'=>'백업 문서','type'=>'upload']],'tools'=>[['toolId'=>'UPLOAD-DOC']],'required'=>false],
        ...
        'Backup' => [
            ...
            'steps'          => [
                ...
                ['order'=>2,'title'=>'백업 대상·주기','description'=>'B 기술 정책','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'backupPolicy','label'=>'백업 대상 및 주기','type'=>'table']],'tools'=>[['toolId'=>'FORM-RPO-RTO'],['toolId'=>'TABLE-DATA']],'required'=>true],
        ...
        'BCP' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'핵심 업무 식별','description'=>'핵심 업무 영향 분석','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'criticalBiz','label'=>'핵심 업무 목록','type'=>'table']],'tools'=>[['toolId'=>'FORM-RPO-RTO'],['toolId'=>'TABLE-DATA']],'required'=>true],
        ...
        'Mon' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'모니터링 대상','description'=>'시스템·서비스·지표','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'targets','label'=>'모니터링 대상 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'MAPPING']],'required'=>true],
                ['order'=>2,'title'=>'임계값·알람','description'=>'경계/심각 임계값','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'thresholds','label'=>'임계값 설정','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'DASHBOARD']],'required'=>true],
        ...
        'Jobs' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'작업 목록','description'=>'B 자동화 작업','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'jobList','label'=>'스케줄 작업 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-SCHEDULE']],'required'=>true],
                ['order'=>2,'title'=>'스케줄·의존성','description'=>'B Cron/의존','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'schedule','label'=>'스케줄 및 의존성','type'=>'table']],'tools'=>[['toolId'=>'TABLE-SCHEDULE'],['toolId'=>'TIMELINE']],'required'=>true],
        ...
        'Retention' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'데이터 분류','description'=>'A 업무 데이터','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'dataClasses','label'=>'데이터 분류 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA']],'required'=>true],
                ['order'=>2,'title'=>'보관 기간','description'=>'A+B 법규·정책','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'retentionPeriods','label'=>'보관 기간','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'DIAGRAM-LIFE']],'required'=>true],
        ...
        'Review' => [
            ...
            'steps'          => [
                ...
                ['order'=>2,'title'=>'주기 및 담당자','description'=>'A 담당 지정','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'schedule','label'=>'주기 및 담당자','type'=>'table']],'tools'=>[['toolId'=>'TIMELINE'],['toolId'=>'MATRIX-RACI']],'required'=>true],
        ...
        'Config' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'하드웨어 구성','description'=>'B CMDB 표준','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'hardware','label'=>'하드웨어 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-CONFIG']],'required'=>true],
                ['order'=>2,'title'=>'소프트웨어 구성','description'=>'B 버전·라이선스','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'software','label'=>'소프트웨어 목록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-CONFIG']],'required'=>true],
                ...
                ['order'=>4,'title'=>'환경별 차이','description'=>'B Dev/Stg/Prd','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'envDiff','label'=>'환경별 차이','type'=>'table']],'tools'=>[['toolId'=>'TABLE-CONFIG']],'required'=>false],
        ...
        'Test' => [
            ...
            'steps'          => [
                ...
                ['order'=>2,'title'=>'테스트 케이스 작성','description'=>'입력값/기대결과/우선순위','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'testCases','label'=>'테스트 케이스','type'=>'table']],'tools'=>[['toolId'=>'TABLE-CASE']],'required'=>true],
                ['order'=>3,'title'=>'테스트 데이터 준비','description'=>'마스킹된 샘플 데이터','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'testData','label'=>'테스트 데이터','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA']],'required'=>false],
                ['order'=>4,'title'=>'실행 및 결과 기록','description'=>'Pass/Fail, 결함 ID','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'execResults','label'=>'실행 결과','type'=>'table']],'tools'=>[['toolId'=>'TABLE-CASE'],['toolId'=>'UPLOAD-EVIDENCE']],'required'=>true],
        ...
        'Deploy' => [
            ...
            'steps'          => [
                ...
                ['order'=>5,'title'=>'배포 기록','description'=>'실시일·담당자·결과','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'deployLog','label'=>'배포 기록','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'UPLOAD-EVIDENCE']],'required'=>false],
        ...
        'Train' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'대상·역할별 커리큘럼','description'=>'A+B 역할별 항목 매핑','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'curriculum','label'=>'교육 커리큘럼','type'=>'table']],'tools'=>[['toolId'=>'MATRIX-RACI'],['toolId'=>'TABLE-DATA']],'required'=>true],
                ['order'=>2,'title'=>'교육 자료','description'=>'B 매뉴얼·동영상','inputType'=>'upload','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'materials','label'=>'교육 자료','type'=>'upload']],'tools'=>[['toolId'=>'UPLOAD-DOC'],['toolId'=>'AI-CHAT']],'required'=>false],
        ...
        'SLA' => [
            ...
            'steps'          => [
                ...
                ['order'=>2,'title'=>'Severity 정의','description'=>'A+B P1~P4','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'severity','label'=>'Severity 등급 정의','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'AI-CHAT']],'required'=>true],
                ...
                ['order'=>5,'title'=>'패널티/포상','description'=>'A+B 계약 조항','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'penalties','label'=>'패널티 및 포상','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA']],'required'=>false],
                ...
                ['order'=>7,'title'=>'검토 및 확정','description'=>'이해관계자 검토, 승인','inputType'=>'review','fields'=>[['key'=>'reviewNotes','label'=>'검토 의견','type'=>'textarea']],'tools'=>[['toolId'=>'APPROVE'],['toolId'=>'EXPORT']],'required'=>true],
            ],
        ],
        ...
        'Escal' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'서비스 티어 정의','description'=>'A+B L1/L2/L3','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'tiers','label'=>'서비스 티어','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'AI-CHAT']],'required'=>true],
        ...
        'Change' => [
            ...
            'steps'          => [
                ['order'=>1,'title'=>'변경 분류 정의','description'=>'A+B Std/Normal/Emergency','inputType'=>'table','fields'=>[['key'=>'overview','label'=>'개요','type'=>'textarea'],['key'=>'changeTypes','label'=>'변경 유형 정의','type'=>'table']],'tools'=>[['toolId'=>'TABLE-DATA'],['toolId'=>'FORM-CHECKLIST']],'required'=>true],
