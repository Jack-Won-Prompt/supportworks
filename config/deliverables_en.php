...
return [
    ...
    'deliverables' => [
        ...
        'USR' => [
            ...
            'steps' => [
                ...
                3 => ['title' => 'Business Functional Requirements',    'description' => 'Functional requirements list',
                      'fields' => ['overview' => 'Overview', 'funcReqs'       => 'Functional Requirements']],
                4 => ['title' => 'Business Migration Requirements',     'description' => 'Migration procedures, availability',
                      'fields' => ['overview' => 'Overview', 'migrationReqs'  => 'Migration Requirements']],
                ...
                6 => ['title' => 'IT Requirements',                     'description' => 'Performance, security, integration',
                      'fields' => ['overview' => 'Overview', 'itReqs'          => 'IT Requirements']],
        ...
        'FRS' => [
            ...
            'steps' => [
                ...
                4 => ['title' => 'Functional Specification',            'description' => 'Screen and function behavior',
                      'fields' => ['overview' => 'Overview', 'funcSpec'         => 'Functional Specification']],
                5 => ['title' => 'Interface Definition',                'description' => 'API and integration systems',
                      'fields' => ['overview' => 'Overview', 'interfaces'       => 'Interface List']],
        ...
        'InfoSec' => [
            ...
            'steps' => [
                1 => ['title' => 'Asset & Data Classification',         'description' => 'Asset and sensitivity input (A)',
                      'fields' => ['overview' => 'Overview', 'assets'           => 'Asset List']],
                ...
                5 => ['title' => 'Residual Risk & Approval',            'description' => 'Stakeholder review, approval',
        ...
        'RoPA' => [
            ...
            'timing' => 'Before Contract Execution (OneTrust)',
            'steps' => [
                1 => ['title' => 'Processing Purpose & Legal Basis',    'description' => 'Processing purpose · regulations',
                      'fields' => ['purpose'           => 'Processing Purpose and Legal Basis']],
                2 => ['title' => 'Personal Data Items',                 'description' => 'A+B collected items',
                      'fields' => ['overview' => 'Overview', 'piiItems'           => 'Personal Data Items']],
                3 => ['title' => 'Processing Flow',                     'description' => 'B system flow',
                      'fields' => ['flowDesc'           => 'Data Processing Flow']],
                4 => ['title' => 'Retention & Disposal',                'description' => 'Retention period · disposal procedure',
                      'fields' => ['overview' => 'Overview', 'retention'          => 'Retention and Disposal Policy']],
                5 => ['title' => 'Third-Party & Cross-Border Transfer', 'description' => 'Third-party · cross-border transfer details',
                      'fields' => ['thirdParty'         => 'Third-Party Transfer Information']],
                6 => ['title' => 'Review & Registration',               'description' => 'Stakeholder review, approval',
                      'fields' => ['reviewNotes'        => 'Review Notes']],
            ],
        ],
        ...
        'Access' => [
            ...
            'steps' => [
                1 => ['title' => 'Role Definition',                     'description' => 'A business roles',
                      'fields' => ['overview' => 'Overview', 'roles'             => 'Role List']],
                ...
                5 => ['title' => 'SSO / Account Management',           'description' => 'SSO integration · account management policy',
                      'fields' => ['ssoPolicy'          => 'SSO and Account Policy']],
                6 => ['title' => 'Review & Approval',                   'description' => 'Stakeholder review, approval',
                      'fields' => ['reviewNotes'        => 'Review Notes']],
            ],
        ],
        ...
        'Audit' => [
            ...
            'steps' => [
                1 => ['title' => 'Log Target Identification',           'description' => 'Transactions and data',
                      'fields' => ['overview' => 'Overview', 'logTargets'        => 'Log Target List']],
                2 => ['title' => 'Log Schema Definition',               'description' => 'Who / What / When / Where / Why',
                      'fields' => ['overview' => 'Overview', 'logSchema'          => 'Log Schema']],
        ...
        'PhySec' => [
            ...
            'steps' => [
                ...
                4 => ['title' => 'Backup Attachment & Summary',         'description' => 'Security backup upload',
                      'fields' => ['overview' => 'Overview', 'backupDoc'          => 'Backup Document']],
                5 => ['title' => 'Review & Approval',                   'description' => 'Stakeholder review, approval',
                      'fields' => ['reviewNotes'        => 'Review Notes']],
            ],
        ],
        ...
        'Backup' => [
            ...
            'steps' => [
                ...
                2 => ['title' => 'Backup Targets & Schedule',           'description' => 'B technical policy',
                      'fields' => ['overview' => 'Overview', 'backupPolicy'       => 'Backup Targets and Schedule']],
        ...
        'BCP' => [
            ...
            'timing' => 'Before Project Handover',
            'steps' => [
                1 => ['title' => 'Critical Business Identification',    'description' => 'Critical business impact analysis',
                      'fields' => ['overview' => 'Overview', 'criticalBiz'        => 'Critical Business List']],
        ...
        'Mon' => [
            ...
            'steps' => [
                1 => ['title' => 'Monitoring Targets',                  'description' => 'Systems, services, metrics',
                      'fields' => ['overview' => 'Overview', 'targets'             => 'Monitoring Target List']],
                2 => ['title' => 'Thresholds & Alerts',                 'description' => 'Warning / critical thresholds',
                      'fields' => ['overview' => 'Overview', 'thresholds'          => 'Threshold Configuration']],
        ...
        'Jobs' => [
            ...
            'steps' => [
                1 => ['title' => 'Job List',                            'description' => 'B automated tasks',
                      'fields' => ['overview' => 'Overview', 'jobList'              => 'Scheduled Job List']],
                2 => ['title' => 'Schedule & Dependencies',             'description' => 'B Cron / dependencies',
                      'fields' => ['overview' => 'Overview', 'schedule'             => 'Schedule and Dependencies']],
        ...
        'Retention' => [
            ...
            'steps' => [
                1 => ['title' => 'Data Classification',                 'description' => 'A business data',
                      'fields' => ['overview' => 'Overview', 'dataClasses'          => 'Data Classification List']],
                2 => ['title' => 'Retention Periods',                   'description' => 'A+B laws / policies',
                      'fields' => ['overview' => 'Overview', 'retentionPeriods'     => 'Retention Periods']],
        ...
        'Review' => [
            ...
            'steps' => [
                ...
                2 => ['title' => 'Schedule & Assignees',                'description' => 'A assignment',
                      'fields' => ['overview' => 'Overview', 'schedule'              => 'Schedule and Assignees']],
        ...
        'Config' => [
            ...
            'steps' => [
                1 => ['title' => 'Hardware Configuration',              'description' => 'B CMDB standards',
                      'fields' => ['overview' => 'Overview', 'hardware'              => 'Hardware List']],
                2 => ['title' => 'Software Configuration',              'description' => 'B versions / licenses',
                      'fields' => ['overview' => 'Overview', 'software'              => 'Software List']],
                ...
                4 => ['title' => 'Environment Differences',             'description' => 'B Dev / Stg / Prd',
                      'fields' => ['overview' => 'Overview', 'envDiff'               => 'Environment Differences']],
        ...
        'Test' => [
            ...
            'steps' => [
                ...
                2 => ['title' => 'Test Case Creation',                  'description' => 'Input / expected results / priority',
                      'fields' => ['overview' => 'Overview', 'testCases'              => 'Test Cases']],
                3 => ['title' => 'Test Data Preparation',               'description' => 'Masked sample data',
                      'fields' => ['overview' => 'Overview', 'testData'               => 'Test Data']],
                4 => ['title' => 'Execution & Result Recording',        'description' => 'Pass / Fail, defect ID',
                      'fields' => ['overview' => 'Overview', 'execResults'            => 'Execution Results']],
        ...
        'Deploy' => [
            ...
            'steps' => [
                ...
                5 => ['title' => 'Deployment Log',                      'description' => 'Date, assignee, result',
                      'fields' => ['overview' => 'Overview', 'deployLog'              => 'Deployment Log']],
        ...
        'Train' => [
            ...
            'steps' => [
                1 => ['title' => 'Curriculum by Role',                  'description' => 'A+B role-based item mapping',
                      'fields' => ['overview' => 'Overview', 'curriculum'             => 'Training Curriculum']],
                2 => ['title' => 'Training Materials',                  'description' => 'B manuals / videos',
                      'fields' => ['overview' => 'Overview', 'materials'              => 'Training Materials']],
        ...
        'SLA' => [
            ...
            'steps' => [
                ...
                2 => ['title' => 'Severity Definition',                 'description' => 'A+B P1~P4',
                      'fields' => ['overview' => 'Overview', 'severity'               => 'Severity Level Definition']],
                ...
                5 => ['title' => 'Penalties & Rewards',                 'description' => 'A+B contract terms',
                      'fields' => ['overview' => 'Overview', 'penalties'              => 'Penalties and Rewards']],
                6 => ['title' => 'Reporting & Review',                  'description' => 'A+B frequency',
                      'fields' => ['reporting'              => 'Reporting and Review Frequency']],
                7 => ['title' => 'Review & Approval',                   'description' => 'Stakeholder review, approval',
                      'fields' => ['reviewNotes'            => 'Review Notes']],
            ],
        ],
        ...
        'Escal' => [
            ...
            'steps' => [
                1 => ['title' => 'Service Tier Definition',             'description' => 'A+B L1 / L2 / L3',
                      'fields' => ['overview' => 'Overview', 'tiers'                  => 'Service Tiers']],
        ...
        'Change' => [
            ...
            'steps' => [
                1 => ['title' => 'Change Type Definition',              'description' => 'A+B Std / Normal / Emergency',
                      'fields' => ['overview' => 'Overview', 'changeTypes'            => 'Change Type Definition']],
